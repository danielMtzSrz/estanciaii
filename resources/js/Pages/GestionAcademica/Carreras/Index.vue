    ...
    <GenericLayout titleModule="Carreras">
        <template #content>
            ...
            >
                <template #header>
                    <Button
                        v-if="hasPermission('GestionAcademica.Carreras.store')"
                        type="button"
                        label="Nuevo"
                        icon="pi pi-plus"
                ...
                <template #buttons="{ data }">
                    <Button
                        v-if="hasPermission('GestionAcademica.Carreras.update')"
                        type="button"
                        icon="pi pi-pencil"
                    ...
                    />
                    <Button
                        v-if="hasPermission('GestionAcademica.Carreras.destroy')"
                        type="button"
                        icon="pi pi-trash"
