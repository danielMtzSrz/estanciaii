<template>
    <GenericLayout titleModule="Asesorías">
        <template #content>
            <DynamicTable
                :data="asesorias"
                :items="items"
                titleModule="Asesorías"
            >
                <template #header>
                    <Button
                        v-if="hasPermission('GestionAcademica.Asesorias.store')"
                        type="button"
                        label="Nuevo"
                        icon="pi pi-plus"
                ...
                <template #buttons="{ data }">
                    <Button
                        v-if="hasPermission('GestionAcademica.Asesorias.update')"
                        type="button"
                        icon="pi pi-pencil"
                    ...
                    />
                    <Button
                        v-if="hasPermission('GestionAcademica.Asesorias.destroy')"
                        type="button"
                        icon="pi pi-trash"
                        ...
                        @click="modalGenericAlert({
                            ...
                            proceso: {
                                'proceso': 'delete',
                                'ruta': 'GestionAcademica.Asesorias.destroy',
                            }
                        })"
                    />
                </template>
...
import CreateUpdate from "@/Pages/GestionAcademica/Asesorias/CreateUpdate.vue";
...
const items = ref([
    ...
    {
        dataField: {
            field: 'user_profile_photo_path',
            avatarText : 'user_nombre',
            header : 'Asesor',
            sortable: true,
            type: 'avatar',
        },
