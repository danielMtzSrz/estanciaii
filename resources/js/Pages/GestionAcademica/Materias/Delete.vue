<template>
    ...
    <GenericModal :dataModal="dataModal" @cerrarModal="cerrarModal"> 
       ...
       <template #content>
           <div class="d-flex align-items-center">
               ...
               <span>¿Seguro que desea eliminar la materia <strong>{{ dataModal.dataRegistro?.nombre }}</strong>?</span>
           </div>
 ...
 <script setup>
    ...
    const eliminarRegistro = () => {
        form.delete(route("GestionAcademica.Materias.destroy", props.dataModal.dataRegistro), {
            onSuccess: () => {
                cerrarModal();
            },
        });
