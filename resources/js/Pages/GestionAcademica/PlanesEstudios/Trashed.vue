<template>
    <GenericLayout titleModule="Planes de estudios eliminados">
        <template #content>
            <GenericTable :data="planesEstudios">
                <template #headerContent>
                    <Link :href="route('GestionAcademica.PlanesEstudios.index')">
                        <Button
                            type="button"
                            label="Regresar"
                        ...
                        <template #body="slotProps">
                            ...
                            <Button
                                ...
                                @click="modalGenericAlert(slotProps.data, true, 
                                    {
                                    'proceso': 'restore',
                                    'ruta': 'GestionAcademica.PlanesEstudios.restore',
                                    'registro': `${slotProps.data.carrera.nombre}`
                                    }
                                )"
                            />
                            <Button
                                ...
                                @click="modalGenericAlert(slotProps.data, true, 
                                    {
                                    'proceso': 'forceDelete',
                                    'ruta': 'GestionAcademica.PlanesEstudios.forceDelete',
                                    'registro': `${slotProps.data.carrera.nombre}`
                                    }
                                )"
                            />
