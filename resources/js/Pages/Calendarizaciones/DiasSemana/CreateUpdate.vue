...
watch(() => props.dataModal, (newVal, oldVal) => {
    ...
    ruta.value = !props.dataModal.dataRegistro ? 'Calendarizaciones.DiasSemana.store' : 'Calendarizaciones.DiasSemana.update'
    titulo.value = !props.dataModal.dataRegistro ? 'Nuevo día de la semana' : 'Actualizar día de la semana'
