<template>
    <GenericLayout titleModule="Días de la semana eliminados">
        <template #content>
            <GenericTable :data="diasSemana">
                <template #headerContent>
                    <Link :href="route('Calendarizaciones.DiasSemana.index')">
                        <Button
                            type="button"
                            label="Regresar"
                        ...
                        <template #body="slotProps">
                            ...
                            <Button
                                ...
                                @click="modalGenericAlert(slotProps.data, true, 
                                    {
                                    'proceso': 'restore',
                                    'ruta': 'Calendarizaciones.DiasSemana.restore',
                            ...
                            <Button
                                ...
                                @click="modalGenericAlert(slotProps.data, true, 
                                    {
                                    'proceso': 'forceDelete',
                                    'ruta': 'Calendarizaciones.DiasSemana.forceDelete',
                                    'registro': `${slotProps.data.nombre}`
                                    }
                                )"
                            />
