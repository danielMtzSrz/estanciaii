        ...
        <template #content>
            <GenericTable :data="convocatorias">
                <template #headerContent>
                    ...
                    />
                    <Link :href="route('Calendarizaciones.Convocatorias.trashed')">
                        <Button 
                            type="button"
                            label="Papelera"
                            icon="pi pi-trash"
...
import FormCreateUpdate from '@/Pages/Calendarizaciones/Convocatorias/CreateUpdate.vue';
import FormDelete from '@/Pages/Calendarizaciones/Convocatorias/Delete.vue';
