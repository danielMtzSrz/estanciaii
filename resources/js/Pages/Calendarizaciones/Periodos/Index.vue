    ...
    <GenericLayout titleModule="Periodos">
        <template #content>
            <DynamicTable
                :data="periodos"
                :items="items"
                titleModule="Periodos"
            >
                <template #header>
                    <Button
                        v-if="hasPermission('Calendarizaciones.Periodos.store')"
                        type="button"
                        label="Nuevo"
                        icon="pi pi-plus"
                ...
                <template #buttons="{ data }">
                    <Button
                        v-if="hasPermission('Calendarizaciones.Periodos.update')"
                        type="button"
                        icon="pi pi-pencil"
                    ...
                    />
                    <Button
                        v-if="hasPermission('Calendarizaciones.Periodos.destroy')"
                        type="button"
                        icon="pi pi-trash"
                        ...
                        @click="modalGenericAlert({
                            ...
                            proceso: {
                                'proceso': 'delete',
                                'ruta': 'Calendarizaciones.Periodos.destroy',
                            }
                        })"
                    />
                </template>
        ...
        <template #footer>
            <CreateUpdate
                :dataModal="{
                    ...
                    dataTiposPeriodo: tipos_periodo
                }"
...
import CreateUpdate from "@/Pages/Calendarizaciones/Periodos/CreateUpdate.vue";
