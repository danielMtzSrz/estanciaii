<template>
    <GenericLayout titleModule="Tipos de convocatorias eliminadas">
        <template #content>
            <GenericTable :data="tipoConvocatoria">
                <template #headerContent>
                    <Link :href="route('Calendarizaciones.TipoConv.index')">
                        <Button
                            type="button"
                            label="Regresar"
                        ...
                        <template #body="slotProps">
                            ...
                            <Button
                                ...
                                @click="modalGenericAlert(slotProps.data, true, 
                                    {
                                    'proceso': 'restore',
                                    'ruta': 'Calendarizaciones.TipoConv.restore',
                            ...
                            <Button
                                ...
                                @click="modalGenericAlert(slotProps.data, true, 
                                    {
                                    'proceso': 'forceDelete',
                                    'ruta': 'Calendarizaciones.TipoConv.forceDelete',
                                    'registro': `${slotProps.data.nombre}`
                                    }
                                )"
                            />
