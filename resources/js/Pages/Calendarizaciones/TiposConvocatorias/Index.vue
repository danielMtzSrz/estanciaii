    ...
    <GenericLayout titleModule="Tipos de convocatoria">
        <template #content>
            ...
            >
                <template #header>
                    <Button
                        v-if="hasPermission('Calendarizaciones.TiposConvocatoria.store')"
                        type="button"
                        label="Nuevo"
                        icon="pi pi-plus"
                ...
                <template #buttons="{ data }">
                    <Button
                        v-if="hasPermission('Calendarizaciones.TiposConvocatoria.update')"
                        type="button"
                        icon="pi pi-pencil"
                    ...
                    />
                    <Button
                        v-if="hasPermission('Calendarizaciones.TiposConvocatoria.destroy')"
                        type="button"
                        icon="pi pi-trash"
