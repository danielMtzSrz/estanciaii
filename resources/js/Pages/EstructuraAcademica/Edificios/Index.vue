<template>
    <GenericLayout titleModule="Edificios">
        <template #content>
            <GenericTable :data="edificios">
                <template #headerContent>
                    ...
                    <Link :href="route('EstructuraAcademica.Edificios.trashed')">
                        ...
                        <template #body="slotProps">
                            ...
                            <Button type="button" icon="pi pi-trash"
                                class="p-button-danger p-button-text p-button-raised p-button-rounded" @click="modalGenericAlert(slotProps.data, true,
                                    {
                                        'proceso': 'destroy',
                                        'ruta': 'EstructuraAcademica.Edificios.destroy',
                                        'registro': `del edificio ${slotProps.data.nombre}`
                                    }
                                )" />
                        </template>
                    </Column>
