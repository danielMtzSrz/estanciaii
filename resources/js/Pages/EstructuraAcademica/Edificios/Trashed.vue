<template>
    <GenericLayout titleModule="Edificios eliminados">
        <template #content>
            <GenericTable :data="edificios">
                <template #headerContent>
                    <Link :href="route('EstructuraAcademica.Edificios.index')">
                        ...
                        <template #body="slotProps">
                            <Button type="button" icon="bi bi-arrow-counterclockwise"
                                ...
                                v-tooltip.top="'Restaurar'" @click="modalGenericAlert(slotProps.data, true,
                                    {
                                        'proceso': 'restore',
                                        'ruta': 'EstructuraAcademica.Edificios.restore',
                            ...
                            <Button type="button" icon="pi pi-trash"
                                ...
                                v-tooltip.top="'Eliminar definitivamente'" @click="modalGenericAlert(slotProps.data, true,
                                    {
                                        'proceso': 'forceDelete',
                                        'ruta': 'EstructuraAcademica.Edificios.forceDelete',
                                        'registro': `con nombre ${slotProps.data.nombre}`
                                    }
                                )" />
                        </template>
