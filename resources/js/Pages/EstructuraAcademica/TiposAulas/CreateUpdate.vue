...
watch(() => props.dataModal, (newVal, oldVal) => {
    ruta.value = !props.dataModal.dataRegistro ? 'EstructuraAcademica.TiposAulas.store' : 'EstructuraAcademica.TiposAulas.update'
    titulo.value = !props.dataModal.dataRegistro ? 'Nuevo tipo de aula' : 'Actualizar tipo de aula'
})
