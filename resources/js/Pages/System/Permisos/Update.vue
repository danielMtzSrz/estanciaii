<template>
    ...
    >
        <div class="flex justify-between mt-0 mb-2">
            <h3 class="font-bold">Actualizar permiso</h3>
            <button
                @click="cerrarModal()"
...
export default {
    ...
    data() {
        return {
            ...
            display: false,
            form: useForm({
                name: this.dataModal.dataPermisos?.name ?? "",
                description: this.dataModal.dataPermisos?.description ?? "",
                _method: "put",
            }),
            errors: {
                name: "",
    ...
    methods: {
        ...
        submit() {
            /*  Inertia.visit(
                route("permission.update", this.dataModal.dataPermisos),
                {
                    data: this.dataModal.dataPermisos,
                    method: "PUT",
                    preserveState: true,
                    onBefore: () => {
            ...
            this.form.post(route("permission.update", this.dataModal.dataPermisos.id), {
                    method: "PUT",
                    preserveState: true,
                    onSuccess: () => {
                        this.cerrarModal();
