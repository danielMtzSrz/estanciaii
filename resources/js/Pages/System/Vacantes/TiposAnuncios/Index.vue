<template>
    <GenericLayout titleModule="Tipos de anuncios">
        <template #content>
            <DynamicTable
                :data="tipos_anuncios"
                :items="items"
                titleModule="Tipos de anuncios"
            >
                <template #header>
                    <Button
                        v-if="hasPermission('tiposanuncios.store')"
                        type="button"
                        label="Nuevo"
                        icon="pi pi-plus"
                ...
                <template #buttons="{ data }">
                    <Button
                        v-if="hasPermission('tiposanuncios.update')"
                        type="button"
                        icon="pi pi-pencil"
                    ...
                    />
                    <Button
                        v-if="hasPermission('tiposanuncios.destroy')"
                        type="button"
                        icon="pi pi-trash"
...
import CreateUpdate from "@/Pages/System/Vacantes/TiposAnuncios/CreateUpdate.vue";
...
const items = ref([
    ...
    },
    {
        dataField: {
            field: 'imagen',
            header : 'Imagen del tipo de anuncio',
            sortable: true,
            type: 'image',
        },
        filters: {
