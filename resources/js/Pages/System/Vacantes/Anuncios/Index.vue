<template>
    <GenericLayout titleModule="Anuncios">
        <template #content>
            <DynamicTable
                :data="anuncios"
                :items="items"
            ...
            >
                <template #header>
                    <Button
                        v-if="hasPermission('anuncios.store')"
                        type="button"
                        label="Nuevo"
                        icon="pi pi-plus"
                ...
                <template #buttons="{ data }">
                    <Button
                        v-if="hasPermission('anuncios.update')"
                        type="button"
                        icon="pi pi-pencil"
                    ...
                    />
                    <Button
                        v-if="hasPermission('anuncios.destroy')"
                        type="button"
                        icon="pi pi-trash"
...
import CreateUpdate from "@/Pages/System/Vacantes/Anuncios/CreateUpdate.vue";
