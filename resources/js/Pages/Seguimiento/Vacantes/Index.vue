<template>
    ...
    <app-layout>
        <h1 class="display-6 text-center my-2">Vacantes</h1>
        <div class="card mb-4">
            <DataTable
            ...
            >
                ...
                <Column header="Contenido">
                    <template #body="slotProps">
                        <div v-html="slotProps.data.contenido"></div>
                    </template>
                </Column>
                ...
                <template #footer>
                    <div>
                        Total de registros: {{ empresas ? empresas.length : 0 }}
                    </div>
                </template>
            </DataTable>
        </div>
...
import ModalCrear from "@/Pages/Seguimiento/Vacantes/Create.vue";
import ModalActualizar from "@/Pages/Seguimiento/Vacantes/Update.vue";
import ModalBorrar from "@/Pages/Seguimiento/Vacantes/Delete.vue";
