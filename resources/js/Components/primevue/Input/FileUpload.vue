<template>
    <div class="p-fileupload p-fileupload-advanced p-component" v-if="isAdvanced">
        <div class="p-fileupload-buttonbar">
            <span :class="advancedChooseButtonClass" class="p-button-text p-button-rounded" :style="style" @click="choose" @keydown.enter="choose" @focus="onFocus" @blur="onBlur" v-ripple tabindex="0">
                ...
                <span class="p-button-label">Subir</span>
            </span>
            <!-- <FileUploadButton :label="uploadButtonLabel" :icon="uploadIcon" @click="upload" :disabled="uploadDisabled" v-if="showUploadButton" /> -->
            <FileUploadButton class="p-button-text p-button-rounded p-button-warning" label="Cancelar" :icon="cancelIcon" @click="clear" :disabled="cancelDisabled" v-if="showCancelButton" />
        </div>
        <div ref="content" class="p-fileupload-content" @dragenter="onDragEnter" @dragover="onDragOver" @dragleave="onDragLeave" @drop="onDrop">
            ...
            <div class="p-fileupload-files" v-if="hasFiles">
                <div class="p-fileupload-row" v-for="(file, index) of files" :key="file.name + file.type + file.size">
                    ...
                    <div>
                        <FileUploadButton type="button" icon="pi pi-times" class="p-button-text p-button-rounded p-button-danger" @click="remove(index)" />
                    </div>
                </div>
            </div>
...
export default {
    ...
    props: {
        ...
        invalidFileSizeMessage: {
            type: String,
            default: '{0}: Archivo demasiado grande, el archivo debe de pesar menos de {1}.'
        },
        invalidFileTypeMessage: {
            type: String,
            default: '{0}: Archivo invalido, tipos de archivo permitidos: {1}.'
        },
        fileLimit: {
            type: Number,
            default: null
